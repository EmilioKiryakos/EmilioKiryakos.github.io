...
let face = "something that people look at."; /*Between the quotation marks, 
...
let red = "My favorite color in most clothes I wear."; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "A human body part with lots of intelligence"; //repeat the instructions for the word "brain"

let masculine = "A term that defines man-like characteristics"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "An action you do to solve problems"; //define 'think' in VERB form,
