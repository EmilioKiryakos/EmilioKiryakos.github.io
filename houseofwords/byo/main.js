...
var word = "definition";
var madlib = `use your ${word} in a sentence. `;
...
var bed = "a place when tired and sleepy sometimes dreaming";
var madlib = `I went to ${bed} and imagined being able to fly and travel across the world.`;
