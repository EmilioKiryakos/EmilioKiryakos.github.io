...
let ctrls = {
    ...
    clr1: {r:200, g:35, b:12}, //color 1
    clr2:{ r:10, g:46, b:0}, //color 2
    d_range: {min: 2, max:30}, //range of sphere diameters
    explode_factor: 0.2, //explode distance
    light_intensity: 1
...
function triggerNote(note) {
    ...
    sphere.position.x = note.number - 60;
    sphere.position.y = Math.ceil(Math.random() * 20) - 5;
    sphere.position.z = Math.ceil(Math.random() * 20) - 5;
